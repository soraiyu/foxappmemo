...
- Disabled Gradle dependency metadata in APK/bundle for F-Droid signing block compatibility

### Added

- Added workflow to retrieve APK signing certificate hash

## [1.2.1] - 2026-04-12

### Fixed

- Release workflow now correctly builds and signs the release APK using keystore secrets
